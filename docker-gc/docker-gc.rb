...
def delete_container(id)
  system "curl -s --unix-socket /var/run/docker.sock -X DELETE http://127.0.0.1:4243/containers/#{id}"
end
...
def delete_image(tag_or_id)
  system "curl -s --unix-socket /var/run/docker.sock -X DELETE http://127.0.0.1:4243/images/#{tag_or_id}"
end
